...
- Python also exports and prints a CIR analysis table under `IRs/IR_tables`, plus CIR shock-size profile figures under `IRs/IR_CIR`. The table reports amplification, attenuation, and asymmetry in percent, and reports sectoral correlations as unitless coefficients.
