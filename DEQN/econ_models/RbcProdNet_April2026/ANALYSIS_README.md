...
- Python also exports and prints a CIR optimal-attenuation table under `IRs/IR_tables`. It reports compact fractional-difference measures in three panels: MIT shock vs 1st-order approximation, global solution vs MIT shock, and sectoral correlations.
