...
class RbcProdNet:
    """A JAX implementation of an RBC Production Network model with fundamental methods only."""
    ...
    def mc_shocks(self, rng=random.PRNGKey(0), mc_draws=8):
        ...
        return jax.random.multivariate_normal(rng, jnp.zeros((self.n_sectors,)), self.Sigma_A, shape=(mc_draws,))
