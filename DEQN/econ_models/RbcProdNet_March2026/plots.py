...
from DEQN.econ_models.RbcProdNet_March2026.plot_helpers import (
...
def plot_sector_ir_by_shock_size(*args, **kwargs):
    return _model_plot_sector_ir_by_shock_size(*args, **kwargs)


def plot_sectoral_variable_ergodic(*args, **kwargs):
    return _model_plot_sectoral_variable_ergodic(*args, **kwargs)
...
def plot_sectoral_capital_stochss(
    stochastic_ss_states: Dict[str, jnp.ndarray],
    save_dir: str,
    analysis_name: str,
    econ_model: Any,
    figsize: Tuple[float, float] = (12, 8),
...
def plot_sectoral_capital_comparison(
    simul_obs: jnp.ndarray,
    stochastic_ss_state: jnp.ndarray,
    save_dir: str,
    analysis_name: str,
    econ_model: Any,
    experiment_label: str,
    ...
    ergodic_capital = jnp.mean(simul_obs, axis=0)[:n_sectors]
