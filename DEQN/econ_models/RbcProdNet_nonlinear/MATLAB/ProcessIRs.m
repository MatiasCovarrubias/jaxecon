function irs = ProcessIRs(dynare_simul,sector_idx,params,steady_state,labels,parn_sectors,endostates_ss, Cagg_ss, Lagg_ss,policies_ss);


    client_idx = labels{1,3}(sector_idx);
    ...
    % Store results 
    irs = [A_ir; C_ir; L_ir; Vc_ir; Cj_ir; Pj_ir; Ioutj_ir; Moutj_ir; Lj_ir; Ij_ir; Mj_ir; Yj_ir; Qj_ir; ...
